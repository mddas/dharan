	...
	<div class="card-body">
		...
		<table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
			...
			<tbody>
				...
				<tr>
					<td>{{$key+1}}</td>
					<td>{{App\Http\Controllers\UserController::get_user_name($activityLog->user_id) ?? 'Null'}}</td>
					<td>{{App\Http\Controllers\UserController::get_user_username($activityLog->user_id)}}</td>
					<td>fixing</td>
